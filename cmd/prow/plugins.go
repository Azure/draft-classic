...
const pluginEnvVar = "PROW_PLUGIN"
...
// as it finds them.
func loadPlugins(baseCmd *cobra.Command, home prowpath.Home, out io.Writer) {
...
// created here.
func setupEnv(shortname, base, plugdirs string, home prowpath.Home) {
	// Set extra env vars:
	for key, val := range map[string]string{
		"PROW_PLUGIN_NAME": shortname,
		...
		"PROW_PACKS_HOME": home.Packs(),
	} {
		os.Setenv(key, val)
	}

	if flagDebug {
		os.Setenv("PROW_DEBUG", "1")
	}
}
