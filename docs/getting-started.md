...
There are multiple example applications included within the [examples directory]. For this walkthrough, we'll be using the [python example application] which uses [Flask](Flask) to provide a very simple Hello World webserver.
