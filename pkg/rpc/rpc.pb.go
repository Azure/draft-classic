...
It has these top-level messages:
	GetLogsRequest
	GetLogsResponse
	GetLatestBuildIDRequest
	GetLatestBuildIDResponse
	AppArchive
	Version
	UpOptions
	UpRequest
...
func (UpSummary_StatusCode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{8, 0} }
...
// GetLatestBuildIDRequest is the message sent to draftd to retrieve the latest build ID for an app
type GetLatestBuildIDRequest struct {
	AppName string `protobuf:"bytes,1,opt,name=app_name,json=appName" json:"app_name,omitempty"`
}

func (m *GetLatestBuildIDRequest) Reset()                    { *m = GetLatestBuildIDRequest{} }
func (m *GetLatestBuildIDRequest) String() string            { return proto.CompactTextString(m) }
func (*GetLatestBuildIDRequest) ProtoMessage()               {}
func (*GetLatestBuildIDRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }

func (m *GetLatestBuildIDRequest) GetAppName() string {
	if m != nil {
		return m.AppName
	}
	return ""
...
// GetLatestBuildIDResponse is the message returned by draftd containing the latest build ID
type GetLatestBuildIDResponse struct {
	BuildID string `protobuf:"bytes,1,opt,name=buildID" json:"buildID,omitempty"`
}

func (m *GetLatestBuildIDResponse) Reset()                    { *m = GetLatestBuildIDResponse{} }
func (m *GetLatestBuildIDResponse) String() string            { return proto.CompactTextString(m) }
func (*GetLatestBuildIDResponse) ProtoMessage()               {}
func (*GetLatestBuildIDResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }

func (m *GetLatestBuildIDResponse) GetBuildID() string {
	if m != nil {
		return m.BuildID
	}
	return ""
...
func (*AppArchive) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*UpOptions) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*UpRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*UpSummary) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*UpMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func init() {
	...
	proto.RegisterType((*GetLatestBuildIDRequest)(nil), "rpc.GetLatestBuildIDRequest")
	proto.RegisterType((*GetLatestBuildIDResponse)(nil), "rpc.GetLatestBuildIDResponse")
...
type DraftClient interface {
	...
	GetLatestBuildID(ctx context.Context, in *GetLatestBuildIDRequest, opts ...grpc.CallOption) (*GetLatestBuildIDResponse, error)
...
func (c *draftClient) GetLatestBuildID(ctx context.Context, in *GetLatestBuildIDRequest, opts ...grpc.CallOption) (*GetLatestBuildIDResponse, error) {
	out := new(GetLatestBuildIDResponse)
	err := grpc.Invoke(ctx, "/rpc.Draft/GetLatestBuildID", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Draft_GetLatestBuildID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLatestBuildIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DraftServer).GetLatestBuildID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Draft/GetLatestBuildID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DraftServer).GetLatestBuildID(ctx, req.(*GetLatestBuildIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Draft_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLatestBuildID",
			Handler:    _Draft_GetLatestBuildID_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
