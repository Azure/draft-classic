...
LDFLAGS += -X github.com/deis/prow/pkg/version.Version=${GIT_TAG}
LDFLAGS += -X github.com/deis/prow/pkg/version.GitCommit=${GIT_COMMIT}
LDFLAGS += -X github.com/deis/prow/pkg/version.GitTreeState=${GIT_DIRTY}
